    ...
    const testimonials = [
        {
          ...
          quote: "Being part of this e-learning platform has truly transformed the way we approach education. The interactive courses and engaging content have made learning a delightful experience for our students."
        },
        {
          avatar: "https://randomuser.me/api/portraits/men/46.jpg",
          name: "Simon Andrew",
          title: "Software Engineer",
          quote: "As a software engineer, I appreciate the depth and quality of the courses on this platform. The instructors provide valuable insights, and the hands-on projects have significantly enhanced my skills."
        },
        {
          avatar: "https://randomuser.me/api/portraits/men/86.jpg",
          name: "Micheal Worin",
          title: "Product Designer",
          quote: "I've had an incredible journey with this e-learning platform. The well-structured courses and practical exercises have honed my design skills, enabling me to create impactful and user-friendly products."
        },
        {
          avatar: "https://randomuser.me/api/portraits/men/66.jpg",
          name: "David Johnson",
          title: "UX/UI Designer",
          quote: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus in leo neque."
        },
        {
          avatar: "https://randomuser.me/api/portraits/men/71.jpg",
          name: "Sara Thompson",
          title: "Marketing Specialist",
          quote: "Vestibulum cursus in ligula vitae eleifend. Morbi commodo semper sem, vel feugiat nulla suscipit at."
        },
        {
          avatar: "https://randomuser.me/api/portraits/men/45.jpg",
          name: "Emily Williams",
          title: "Graphic Designer",
          quote: "Cras ullamcorper dolor in velit cursus, et fringilla libero tincidunt. Aenean et sodales metus."
        },
      ];
      
  return (
    <section className="relative py-14">
    <div className="relative z-10 max-w-screen-2xl mx-auto px-4 md:px-8 font-Poppins ">
        <div className="max-w-xl sm:text-center md:mx-auto">
            <h3 className="text-gray-800 text-3xl font-semibold sm:text-4xl">
                Hear from our customers
            </h3>
            <p className="mt-3 text-gray-600">
            Explore the testimonials from our LMS platform users to gain valuable insights into their experiences. Delve into the unique stories of how our Learning Management System has positively impacted their learning journeys.            </p>
        </div>
        <div className="mt-12">
            <ul className="grid items-center gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {
                    testimonials.map((item, idx) => (
                        <li key={idx} className="bg-white rounded-xl border shadow-md">
                            ...
                            <figure>
                                <blockquote>
                                    <p className="text-gray-800 text-base font-semibold px-4 py-1">
                                        {item.quote}
                                    </p>
                                </blockquote>
    ...
    <div className="absolute top-0 w-full h-[350px] bg-[#EEF4FA]" ></div>
</section>
  )
}
