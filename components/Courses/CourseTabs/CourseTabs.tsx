...
const CourseTabs = ({data}:Props) => {
  ...
  return (
    <Tabs.Root
      className="max-w-screen-2xl mx-auto px-4 mt-40"
      ...
      <Tabs.List
        ...
        <Tabs.Content className="py-6" value="Overview">
          <Overview description={data?.description} benifits={data?.benifits} demoUrl={data?.demoUrl} />
        </Tabs.Content>
        <Tabs.Content className="py-6" value="Course content">
         <CourseContent courseData={data?.courseData}/>
        </Tabs.Content>
        <Tabs.Content className="py-6" value="Requirements">
          <Requirements requirements={data?.requirements}/>
        </Tabs.Content>
        <Tabs.Content className="py-6" value="Reviews">
